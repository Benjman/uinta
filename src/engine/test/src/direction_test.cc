...
// WorldForward tests
TEST(DirectionTest, WorldForwardIsNegativeZ) { EXPECT_EQ(glm::vec3(0, 0, -1), WorldForward); }
...
TEST(DirectionTest, WorldForwardZIsNegativeOne) { EXPECT_EQ(-1.0f, WorldForward.z); }

TEST(DirectionTest, WorldForwardIsUnitVector) { EXPECT_FLOAT_EQ(1.0f, glm::length(WorldForward)); }

// WorldRight tests
TEST(DirectionTest, WorldRightIsPositiveX) { EXPECT_EQ(glm::vec3(1, 0, 0), WorldRight); }
...
TEST(DirectionTest, WorldRightIsUnitVector) { EXPECT_FLOAT_EQ(1.0f, glm::length(WorldRight)); }

// WorldUp tests
TEST(DirectionTest, WorldUpIsPositiveY) { EXPECT_EQ(glm::vec3(0, 1, 0), WorldUp); }
...
TEST(DirectionTest, WorldUpIsUnitVector) { EXPECT_FLOAT_EQ(1.0f, glm::length(WorldUp)); }

// WorldHorizontal tests
TEST(DirectionTest, WorldHorizontalIsSumOfRightAndForward) { EXPECT_EQ(WorldRight + WorldForward, WorldHorizontal); }

TEST(DirectionTest, WorldHorizontalXIsOne) { EXPECT_EQ(1.0f, WorldHorizontal.x); }

TEST(DirectionTest, WorldHorizontalYIsZero) { EXPECT_EQ(0.0f, WorldHorizontal.y); }

TEST(DirectionTest, WorldHorizontalZIsNegativeOne) { EXPECT_EQ(-1.0f, WorldHorizontal.z); }

// Orthogonality tests
TEST(DirectionTest, ForwardAndRightAreOrthogonal) { EXPECT_FLOAT_EQ(0.0f, glm::dot(WorldForward, WorldRight)); }

TEST(DirectionTest, ForwardAndUpAreOrthogonal) { EXPECT_FLOAT_EQ(0.0f, glm::dot(WorldForward, WorldUp)); }

TEST(DirectionTest, RightAndUpAreOrthogonal) { EXPECT_FLOAT_EQ(0.0f, glm::dot(WorldRight, WorldUp)); }
