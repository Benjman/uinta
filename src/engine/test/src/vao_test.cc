...
TEST_F(VaoTest, LinkAttributeCallsVertexAttribPointer) {
  ...
  gl.onVertexAttribPointer = [&](GLuint index, GLint size, GLenum type, GLboolean normalized, GLsizei stride,
                                 const void* pointer) {
...
TEST_F(VaoTest, LinkAttributeWithOffset) {
  ...
  gl.onVertexAttribPointer = [&](GLuint, GLint, GLenum, GLboolean, GLsizei, const void* pointer) {
