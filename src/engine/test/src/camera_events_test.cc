...
TEST_F(CameraEventsTest, CameraDispatchersAddAndDispatchViewMatrixUpdate) {
  ...
  dispatchers.addListener<CameraEvent::ViewMatrixUpdated>([&](const ViewMatrixUpdateEvent& e) {
  ...
  dispatchers.dispatch<CameraEvent::ViewMatrixUpdated>(ViewMatrixUpdateEvent{.camera = &camera, .view = viewMatrix});
...
TEST_F(CameraEventsTest, CameraDispatchersMultipleListeners) {
  ...
  dispatchers.addListener<CameraEvent::ViewMatrixUpdated>([&](const ViewMatrixUpdateEvent&) { callCount++; });
