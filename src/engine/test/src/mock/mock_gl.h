#ifndef SRC_ENGINE_TEST_SRC_MOCK_MOCK_GL_H_
#define SRC_ENGINE_TEST_SRC_MOCK_MOCK_GL_H_
...
class MockOpenGLApi : public OpenGLApi {
 public:
  ...
  std::function<void(GLsizei, GLuint*)> onGenTextures = [](auto, auto*) {};
  void genTextures(GLsizei count, GLuint* ptr) const noexcept override {
    onGenTextures(count, ptr);
  }

  std::function<void(GLuint, GLenum, GLint*)> onGetShaderiv = [](auto, auto,
                                                                 GLint*) {};
  ...
  std::function<void(GLuint, GLenum, GLint*)> onGetProgramiv = [](auto, auto,
                                                                  auto*) {};
  ...
  std::function<void(GLsizei, GLuint*)> onGenVertexArrays = [](auto, auto*) {};
...
#endif  // SRC_ENGINE_TEST_SRC_MOCK_MOCK_GL_H_
