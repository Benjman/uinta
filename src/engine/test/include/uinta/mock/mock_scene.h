...
struct MockScene : Scene {
  ...
  explicit MockScene(Engine* engine, SceneLayer layer = SceneLayer::Simulation) noexcept : Scene(engine, layer) {}

  explicit MockScene(Scene* parent, SceneLayer layer = SceneLayer::Simulation) noexcept : Scene(parent, layer) {}
