...
class OutlinePass : public PostProcessPass {
 public:
  ...
  [[nodiscard]] std::string_view name() const noexcept override { return "Outline"; }
  ...
  [[nodiscard]] f32 depthSensitivity() const noexcept { return depthSensitivity_; }

  void normalSensitivity(f32 v) noexcept { normalSensitivity_ = v; }
  [[nodiscard]] f32 normalSensitivity() const noexcept { return normalSensitivity_; }
