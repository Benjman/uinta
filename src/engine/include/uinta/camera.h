...
class Camera {
  ...
  static constexpr CameraFlags DistLimitMask = 1 << 0;
  static constexpr CameraFlags PitchLimitMask = 1 << 1;
  static constexpr CameraFlags LoggingMask = 1 << 2;
 ...
 private:
  ...
  class CameraLogger {
   public:
    ...
    void update(Camera*, const EngineState&) noexcept;
