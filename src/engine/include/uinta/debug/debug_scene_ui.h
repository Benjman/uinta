...
class DebugSceneUi : public Scene {
 ...
 private:
  struct Flags final {
    ...
    [[nodiscard]] bool isImGuiInitialized() const noexcept { return (flags_ & ImGuiInitializedMask) != 0; }
    ...
    [[nodiscard]] bool isImGuiDeinitialized() const noexcept { return (flags_ & ImGuiDeinitializedMask) != 0; }
    ...
    [[nodiscard]] bool isImGuiNewFrame() const noexcept { return (flags_ & ImGuiNewFrameMask) != 0; }
    ...
    [[nodiscard]] bool isImGuiRendered() const noexcept { return (flags_ & ImGuiRenderedMask) != 0; }
