...
template <>
constexpr ViewportEvent getViewportEvent<ProjectionMatrixUpdateEvent>() noexcept {
...
struct ViewportDispatchers {
  eventpp::EventDispatcher<ViewportEvent, void(const ProjectionMatrixUpdateEvent&), ViewportEventPolicies>
