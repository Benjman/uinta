...
class TextShader : public Shader {
 ...
 public:
  ...
  void linkAttributes(const Vao* vao) const noexcept override {
    constexpr Attribute position(0, 3, GL_FLOAT, GL_FALSE, ElementsPerTextVertex * sizeof(GLfloat),
                                 0 * sizeof(GLfloat));
    constexpr Attribute color(1, 4, GL_FLOAT, GL_FALSE, ElementsPerTextVertex * sizeof(GLfloat), 3 * sizeof(GLfloat));
    constexpr Attribute uv(2, 2, GL_FLOAT, GL_FALSE, ElementsPerTextVertex * sizeof(GLfloat), 7 * sizeof(GLfloat));
