...
class Uniform {
 public:
  Uniform(const std::string_view, const Shader*) noexcept;
...
class Uniform1f : public Uniform<GLfloat> {
 public:
  Uniform1f(const std::string_view, const Shader*) noexcept;
...
class Uniform2f : public Uniform<glm::vec2> {
 public:
  Uniform2f(const std::string_view, const Shader*) noexcept;
...
class Uniform3f : public Uniform<glm::vec3> {
 public:
  Uniform3f(const std::string_view, const Shader*) noexcept;
...
class Uniform4f : public Uniform<glm::vec4> {
 public:
  Uniform4f(const std::string_view, const Shader*) noexcept;
...
class Uniform1i : public Uniform<GLint> {
 public:
  Uniform1i(const std::string_view, const Shader*) noexcept;
...
class Uniform2i : public Uniform<glm::ivec2> {
 public:
  Uniform2i(const std::string_view, const Shader*) noexcept;
...
class Uniform3i : public Uniform<glm::ivec3> {
 public:
  Uniform3i(const std::string_view, const Shader*) noexcept;
...
class Uniform4i : public Uniform<glm::ivec4> {
 public:
  Uniform4i(const std::string_view, const Shader*) noexcept;
...
class Uniform1ui : public Uniform<GLuint> {
 public:
  Uniform1ui(const std::string_view, const Shader*) noexcept;
...
class Uniform2ui : public Uniform<glm::uvec2> {
 public:
  Uniform2ui(const std::string_view, const Shader*) noexcept;
...
class Uniform3ui : public Uniform<glm::uvec3> {
 public:
  Uniform3ui(const std::string_view, const Shader*) noexcept;
...
class Uniform4ui : public Uniform<glm::uvec4> {
 public:
  Uniform4ui(const std::string_view, const Shader*) noexcept;
...
class Uniform1fv : public Uniform<GLfloat> {
 public:
  Uniform1fv(const std::string_view, const Shader*, GLsizei = 1) noexcept;
...
class Uniform2fv : public Uniform<glm::vec2> {
 public:
  Uniform2fv(const std::string_view, const Shader*, GLsizei = 1) noexcept;
...
class Uniform3fv : public Uniform<glm::vec3> {
 public:
  Uniform3fv(const std::string_view, const Shader*, GLsizei = 1) noexcept;
...
class Uniform4fv : public Uniform<glm::vec4> {
 public:
  Uniform4fv(const std::string_view, const Shader*, GLsizei = 1) noexcept;
...
class Uniform1iv : public Uniform<GLint> {
 public:
  Uniform1iv(const std::string_view, const Shader*, GLsizei = 1) noexcept;
...
class Uniform2iv : public Uniform<glm::ivec2> {
 public:
  Uniform2iv(const std::string_view, const Shader*, GLsizei = 1) noexcept;
...
class Uniform3iv : public Uniform<glm::ivec3> {
 public:
  Uniform3iv(const std::string_view, const Shader*, GLsizei = 1) noexcept;
...
class Uniform4iv : public Uniform<glm::ivec4> {
 public:
  Uniform4iv(const std::string_view, const Shader*, GLsizei = 1) noexcept;
...
class Uniform1uiv : public Uniform<u32> {
 public:
  Uniform1uiv(const std::string_view, const Shader*, GLsizei = 1) noexcept;
...
class Uniform2uiv : public Uniform<glm::uvec2> {
 public:
  Uniform2uiv(const std::string_view, const Shader*, GLsizei = 1) noexcept;
...
class Uniform3uiv : public Uniform<glm::uvec3> {
 public:
  Uniform3uiv(const std::string_view, const Shader*, GLsizei = 1) noexcept;
...
class Uniform4uiv : public Uniform<glm::uvec4> {
 public:
  Uniform4uiv(const std::string_view, const Shader*, GLsizei = 1) noexcept;
...
class UniformMatrix2fv : public Uniform<glm::mat2> {
 public:
  UniformMatrix2fv(const std::string_view, const Shader*, GLsizei = 1) noexcept;
...
class UniformMatrix3fv : public Uniform<glm::mat3> {
 public:
  UniformMatrix3fv(const std::string_view, const Shader*, GLsizei = 1) noexcept;
...
class UniformMatrix4fv : public Uniform<glm::mat4> {
 public:
  UniformMatrix4fv(const std::string_view, const Shader*, GLsizei = 1) noexcept;
...
class UniformMatrix2x3fv : public Uniform<glm::mat2x3> {
 public:
  UniformMatrix2x3fv(const std::string_view, const Shader*,
                     GLsizei = 1) noexcept;
...
class UniformMatrix3x2fv : public Uniform<glm::mat3x2> {
 public:
  UniformMatrix3x2fv(const std::string_view, const Shader*,
                     GLsizei = 1) noexcept;
...
class UniformMatrix2x4fv : public Uniform<glm::mat2x4> {
 public:
  UniformMatrix2x4fv(const std::string_view, const Shader*,
                     GLsizei = 1) noexcept;
...
class UniformMatrix4x2fv : public Uniform<glm::mat4x2> {
 public:
  UniformMatrix4x2fv(const std::string_view, const Shader*,
                     GLsizei = 1) noexcept;
...
class UniformMatrix3x4fv : public Uniform<glm::mat3x4> {
 public:
  UniformMatrix3x4fv(const std::string_view, const Shader*,
                     GLsizei = 1) noexcept;
...
class UniformMatrix4x3fv : public Uniform<glm::mat4x3> {
 public:
  UniformMatrix4x3fv(const std::string_view, const Shader*,
                     GLsizei = 1) noexcept;
