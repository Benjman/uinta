...
class Uniform {
 public:
  Uniform(const std::string& name, const Shader* shader) noexcept : gl_(shader->gl()) {
    if (shader->id() == 0u) {
    ...
    if (location_ == -1) {
      LOG(WARNING) << (absl::StrFormat("Shader %i uniform location not found: %s", shader->id(), name));
    }
  }

  [[nodiscard]] T value() const noexcept { return value_; }

  [[nodiscard]] GLint location() const noexcept { return location_; }
...
class Uniform1f : public Uniform<GLfloat> {
 public:
  Uniform1f(const std::string& name, const Shader* shader) noexcept : Uniform(name, shader) {}
...
class Uniform2f : public Uniform<glm::vec2> {
 public:
  Uniform2f(const std::string& name, const Shader* shader) noexcept : Uniform(name, shader) {}
...
class Uniform3f : public Uniform<glm::vec3> {
 public:
  Uniform3f(const std::string& name, const Shader* shader) noexcept : Uniform(name, shader) {}
...
class Uniform4f : public Uniform<glm::vec4> {
 public:
  Uniform4f(const std::string& name, const Shader* shader) noexcept : Uniform(name, shader) {}
...
class Uniform1i : public Uniform<GLint> {
 public:
  Uniform1i(const std::string& name, const Shader* shader) noexcept : Uniform(name, shader) {}
...
class Uniform2i : public Uniform<glm::ivec2> {
 public:
  Uniform2i(const std::string& name, const Shader* shader) noexcept : Uniform(name, shader) {}
...
class Uniform3i : public Uniform<glm::ivec3> {
 public:
  Uniform3i(const std::string& name, const Shader* shader) noexcept : Uniform(name, shader) {}
...
class Uniform4i : public Uniform<glm::ivec4> {
 public:
  Uniform4i(const std::string& name, const Shader* shader) noexcept : Uniform(name, shader) {}
...
class Uniform1ui : public Uniform<GLuint> {
 public:
  Uniform1ui(const std::string& name, const Shader* shader) noexcept : Uniform(name, shader) {}
...
class Uniform2ui : public Uniform<glm::uvec2> {
 public:
  Uniform2ui(const std::string& name, const Shader* shader) noexcept : Uniform(name, shader) {}
...
class Uniform3ui : public Uniform<glm::uvec3> {
 public:
  Uniform3ui(const std::string& name, const Shader* shader) noexcept : Uniform(name, shader) {}
...
class Uniform4ui : public Uniform<glm::uvec4> {
 public:
  Uniform4ui(const std::string& name, const Shader* shader) noexcept : Uniform(name, shader) {}
...
class Uniform1fv : public Uniform<GLfloat> {
 public:
  Uniform1fv(const std::string& name, const Shader* shader, GLsizei count = 1) noexcept
...
class Uniform2fv : public Uniform<glm::vec2> {
 public:
  Uniform2fv(const std::string& name, const Shader* shader, GLsizei count = 1) noexcept
      : Uniform(name, shader), count_(count) {}
...
class Uniform3fv : public Uniform<glm::vec3> {
 public:
  Uniform3fv(const std::string& name, const Shader* shader, GLsizei count = 1) noexcept
      : Uniform(name, shader), count_(count) {}
...
class Uniform4fv : public Uniform<glm::vec4> {
 public:
  Uniform4fv(const std::string& name, const Shader* shader, GLsizei count = 1) noexcept
      : Uniform(name, shader), count_(count) {}
...
class Uniform1iv : public Uniform<GLint> {
 public:
  Uniform1iv(const std::string& name, const Shader* shader, GLsizei count = 1) noexcept
      : Uniform(name, shader), count_(count) {}
...
class Uniform2iv : public Uniform<glm::ivec2> {
 public:
  Uniform2iv(const std::string& name, const Shader* shader, GLsizei count = 1) noexcept
      : Uniform(name, shader), count_(count) {}
...
class Uniform3iv : public Uniform<glm::ivec3> {
 public:
  Uniform3iv(const std::string& name, const Shader* shader, GLsizei count = 1) noexcept
      : Uniform(name, shader), count_(count) {}
...
class Uniform4iv : public Uniform<glm::ivec4> {
 public:
  Uniform4iv(const std::string& name, const Shader* shader, GLsizei count = 1) noexcept
      : Uniform(name, shader), count_(count) {}
...
class Uniform1uiv : public Uniform<u32> {
 public:
  Uniform1uiv(const std::string& name, const Shader* shader, GLsizei count = 1) noexcept
      : Uniform(name, shader), count_(count) {}
...
class Uniform2uiv : public Uniform<glm::uvec2> {
 public:
  Uniform2uiv(const std::string& name, const Shader* shader, GLsizei count = 1) noexcept
      : Uniform(name, shader), count_(count) {}
...
class Uniform3uiv : public Uniform<glm::uvec3> {
 public:
  Uniform3uiv(const std::string& name, const Shader* shader, GLsizei count = 1) noexcept
      : Uniform(name, shader), count_(count) {}
...
class Uniform4uiv : public Uniform<glm::uvec4> {
 public:
  Uniform4uiv(const std::string& name, const Shader* shader, GLsizei count = 1) noexcept
      : Uniform(name, shader), count_(count) {}
...
class UniformMatrix2fv : public Uniform<glm::mat2> {
 public:
  UniformMatrix2fv(const std::string& name, const Shader* shader, GLsizei count = 1) noexcept
      : Uniform(name, shader), count_(count) {}
...
class UniformMatrix3fv : public Uniform<glm::mat3> {
 public:
  UniformMatrix3fv(const std::string& name, const Shader* shader, GLsizei count = 1) noexcept
      : Uniform(name, shader), count_(count) {}
...
class UniformMatrix4fv : public Uniform<glm::mat4> {
 public:
  UniformMatrix4fv(const std::string& name, const Shader* shader, GLsizei count = 1) noexcept
      : Uniform(name, shader), count_(count) {}
...
class UniformMatrix2x3fv : public Uniform<glm::mat2x3> {
 public:
  UniformMatrix2x3fv(const std::string& name, const Shader* shader, GLsizei count = 1) noexcept
      : Uniform(name, shader), count_(count) {}
...
class UniformMatrix3x2fv : public Uniform<glm::mat3x2> {
 public:
  UniformMatrix3x2fv(const std::string& name, const Shader* shader, GLsizei count = 1) noexcept
      : Uniform(name, shader), count_(count) {}
...
class UniformMatrix2x4fv : public Uniform<glm::mat2x4> {
 public:
  UniformMatrix2x4fv(const std::string& name, const Shader* shader, GLsizei count = 1) noexcept
      : Uniform(name, shader), count_(count) {}
...
class UniformMatrix4x2fv : public Uniform<glm::mat4x2> {
 public:
  UniformMatrix4x2fv(const std::string& name, const Shader* shader, GLsizei count = 1) noexcept
      : Uniform(name, shader), count_(count) {}
...
class UniformMatrix3x4fv : public Uniform<glm::mat3x4> {
 public:
  UniformMatrix3x4fv(const std::string& name, const Shader* shader, GLsizei count = 1) noexcept
      : Uniform(name, shader), count_(count) {}
...
class UniformMatrix4x3fv : public Uniform<glm::mat4x3> {
 public:
  UniformMatrix4x3fv(const std::string& name, const Shader* shader, GLsizei count = 1) noexcept
      : Uniform(name, shader), count_(count) {}
