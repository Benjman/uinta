...
struct ApiVersion {
  ...
  [[nodiscard]] constexpr bool isCompatible(const ApiVersion& required) const noexcept {
  ...
  [[nodiscard]] constexpr bool operator!=(const ApiVersion& other) const noexcept { return !(*this == other); }
