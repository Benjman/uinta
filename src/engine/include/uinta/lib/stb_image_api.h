...
class StbImageApiImpl : public StbImageApi {
 public:
  ...
  void setFlipVerticallyOnLoad(bool /*unused*/) const noexcept override;
  u8* load(char const* /*unused*/, i32* /*unused*/, i32* /*unused*/,
           i32* /*unused*/, i32 /*unused*/) const noexcept override;
  void imageFree(void* /*unused*/) const noexcept override;
