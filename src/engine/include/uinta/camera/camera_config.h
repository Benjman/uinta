...
struct CameraConfig {
  struct Flags final {
    ...
    static constexpr value_type DefaultFlags = DistLimitMask | PitchLimitMask | KeyboardEnabledMask | MouseEnabledMask;

    FlagsOperations(DefaultFlags);

    [[nodiscard]] bool isAngleLock() const noexcept { return (flags_ & AngleLockMask) != 0; }
    ...
    [[nodiscard]] bool isDistLimit() const noexcept { return (flags_ & DistLimitMask) != 0; }
    ...
    [[nodiscard]] bool isDistLock() const noexcept { return (flags_ & DistLockMask) != 0; }
    ...
    [[nodiscard]] bool isPitchLimit() const noexcept { return (flags_ & PitchLimitMask) != 0; }
    ...
    [[nodiscard]] bool isPitchLock() const noexcept { return (flags_ & PitchLockMask) != 0; }
    ...
    [[nodiscard]] bool isKeyboardEnabled() const noexcept { return (flags_ & KeyboardEnabledMask) != 0; }
    ...
    [[nodiscard]] bool isMouseEnabled() const noexcept { return (flags_ & MouseEnabledMask) != 0; }
