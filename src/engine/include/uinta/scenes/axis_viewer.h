 ...
 private:
  struct AxisShader : Shader {
    ...
    void linkAttributes(const Vao* vao) const noexcept override {
      constexpr Attribute position(0, 3, GL_FLOAT, GL_FALSE, 6 * sizeof(GLfloat), 0);
      constexpr Attribute color(1, 3, GL_FLOAT, GL_FALSE, 6 * sizeof(GLfloat), 3 * sizeof(GLfloat));
