...
class TextMeshBuilder {
 ...
 public:
  ...
  TextMeshBuilder& align(Alignment alignment) noexcept {
    flags_ &= ~(_::HorizontalMask | _::VerticalMask);
 ...
 private:
  ...
  bool isLeftAligned() const noexcept {
    return ((flags_ & _::HorizontalMask) >> _::HorizontalShift) == _::LeftMask;
  }

  bool isRightAligned() const noexcept {
    return ((flags_ & _::HorizontalMask) >> _::HorizontalShift) == _::RightMask;
  }

  bool isCenterAligned() const noexcept {
    return ((flags_ & _::HorizontalMask) >> _::HorizontalShift) ==
           _::CenterMask;
  }

  bool isTopAligned() const noexcept {
    return ((flags_ & _::VerticalMask) >> _::VerticalShift) == _::TopMask;
  }

  bool isMiddleAligned() const noexcept {
    return ((flags_ & _::VerticalMask) >> _::VerticalShift) == _::MiddleMask;
  }

  bool isBottomAligned() const noexcept {
    return ((flags_ & _::VerticalMask) >> _::VerticalShift) == _::BottomMask;
  }
};
