...
class SmoothVec2 {
 public:
  ...
  explicit SmoothVec2(value_type agility, value_type x = 0, value_type y = 0) noexcept
      : x_(agility, x), y_(agility, y) {}

  SmoothVec2(value_type agility, const glm::vec2& v) noexcept : x_(agility, v.x), y_(agility, v.y) {}
  ...
  bool operator==(const SmoothVec2& other) const noexcept { return x_ == other.x_ && y_ == other.y_; }
  ...
  [[nodiscard]] SmoothFloat x() const noexcept { return x_; }

  void x(const SmoothFloat& v) noexcept { x_ = v; }

  [[nodiscard]] SmoothFloat y() const noexcept { return y_; }
...
class SmoothVec3 {
 public:
  ...
  explicit SmoothVec3(value_type agility, value_type x = 0, value_type y = 0, value_type z = 0) noexcept
      : x_(agility, x), y_(agility, y), z_(agility, z) {}

  SmoothVec3(value_type agility, const glm::vec3& v) noexcept : x_(agility, v.x), y_(agility, v.y), z_(agility, v.z) {}
  ...
  bool operator==(const SmoothVec3& other) const noexcept { return x_ == other.x_ && y_ == other.y_ && z_ == other.z_; }
  ...
  [[nodiscard]] SmoothFloat z() const noexcept { return z_; }
