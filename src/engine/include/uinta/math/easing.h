...
inline f32 easeInSine(f32 x) noexcept { return 1.0f - std::cos((PI * x) / 2.0f); }

inline f32 easeOutSine(f32 x) noexcept { return std::sin((PI * x) / 2.0f); }

inline f32 easeInOutSine(f32 x) noexcept { return -std::cos((PI * x) - 1.0f) / 2.0f; }

inline f32 easeInQuad(f32 x) noexcept { return x * x; }

inline f32 easeOutQuad(f32 x) noexcept { return 1.0f - static_cast<f32>((1.0f - x) * (1.0f - x)); }

inline f32 easeInOutQuad(f32 x) noexcept {
  return x < 0.5f ? 2.0f * x * x : 1.0f - static_cast<f32>(std::pow((-2.0f * x) + 2.0f, 2.0f) / 2.0f);
}

inline f32 easeInCubic(f32 x) noexcept { return x * x * x; }

inline f32 easeOutCubic(f32 x) noexcept { return static_cast<f32>(1.0f - std::pow(1.0f - x, 3)); }

inline f32 easeInOutCubic(f32 x) noexcept {
  return x < 0.5f ? 4.0f * x * x * x : 1.0f - static_cast<f32>(std::pow((-2.0f * x) + 2.0f, 3.0f) / 2.0f);
}

inline f32 easeInQuart(f32 x) noexcept { return x * x * x * x; }

inline f32 easeOutQuart(f32 x) noexcept { return static_cast<f32>(1.0f - std::pow(1.0f - x, 4)); }

inline f32 easeInOutQuart(f32 x) noexcept {
  return x < 0.5f ? 8.0f * x * x * x * x : 1.0f - static_cast<f32>(std::pow((-2.0f * x) + 2.0f, 4.0f) / 2.0f);
}

inline f32 easeInQuint(f32 x) noexcept { return x * x * x * x * x; }

inline f32 easeOutQuint(f32 x) noexcept { return 1.0f - std::pow(1.0f - x, 5.0f); }

inline f32 easeInOutQuint(f32 x) noexcept {
  return x < 0.5f ? 16.0f * x * x * x * x * x : 1.0f - static_cast<f32>(std::pow((-2.0f * x) + 2.0f, 5.0f) / 2.0f);
}

inline f32 easeInExpo(f32 x) noexcept { return x == 0.0f ? 0.0f : std::pow(2.0f, (10.0f * x) - 10.0f); }

inline f32 easeOutExpo(f32 x) noexcept { return x == 1.0f ? 1.0f : 1.0f - static_cast<f32>(std::pow(2, -10 * x)); }
...
inline f32 easeInCirc(f32 x) noexcept { return 1.0f - std::sqrt(1.0f - std::pow(x, 2.0f)); }

inline f32 easeOutCirc(f32 x) noexcept { return std::sqrt(1.0f - std::pow(x - 1.0f, 2.0f)); }
...
inline f32 easeInOutElastic(f32 x) noexcept {
  ...
  if (x < 0.5f) {
    return -(std::pow(2.0f, (20.0f * x) - 10.0f) * std::sin(((20.0f * x) - 11.125f) * c5)) / 2.0f;
  }
  return ((std::pow(2.0f, (-20.0f * x) + 10.0f) * std::sin(((20.0f * x) - 11.125f) * c5)) / 2.0f) + 1.0f;
}
...
inline f32 easeInBounce(f32 x) noexcept { return 1.0f - easeOutBounce(1.0f - x); }
