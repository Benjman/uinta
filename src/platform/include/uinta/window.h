...
class Window {
 public:
  ...
  [[nodiscard]] f32 aspect() const noexcept { return static_cast<f32>(width_) / static_cast<f32>(height_); }
  ...
  void isFullscreen(bool isFullscreen) noexcept { isFullscreen_ = isFullscreen; }
  ...
  [[nodiscard]] u32 x() const noexcept { return x_; }

  [[nodiscard]] u32 y() const noexcept { return y_; }
