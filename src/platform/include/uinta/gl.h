...
struct OpenGLApi {
   ...
   *  @return A non-zero value by which it can be referenced.
   */
  [[nodiscard]] virtual GLuint createShader(
      GLuint shaderType) const noexcept = 0;
   ...
   */
  [[nodiscard]] virtual const GLubyte* errorString(
      GLenum error) const noexcept = 0;
   ...
   * otherwise.
   */
  [[nodiscard]] virtual bool isEnabledi(GLenum cap,
                                        GLuint index) const noexcept = 0;
...
struct OpenGLApiImpl : OpenGLApi {
  ...
  [[nodiscard]] GLuint createProgram() const noexcept override {
    return glCreateProgram();
  }

  [[nodiscard]] GLuint createShader(GLenum stage) const noexcept override {
  ...
  [[nodiscard]] const GLubyte* errorString(
      GLenum error) const noexcept override {
  ...
  [[nodiscard]] bool isEnabledi(GLenum cap,
                                GLuint index) const noexcept override {
    return glIsEnabledi(cap, index);
  }

  [[nodiscard]] bool isEnabled(GLenum cap) const noexcept override {
  ...
  void texStorage2D(GLenum target, GLsizei levels, GLenum internalformat,
                    GLsizei width, GLsizei height) const noexcept override {
...
class DepthTestGuard : public CapabilityGuard {
 public:
  explicit DepthTestGuard(bool isActive = true,
...
class CullFaceGuard : public CapabilityGuard {
 public:
  CullFaceGuard(GLenum mode = GL_BACK, bool isActive = true,
                const OpenGLApi* gl = OpenGLApiImpl::Instance())
