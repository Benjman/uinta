...
struct OpenGLApi {
   ...
   */
  virtual void bindFramebuffer(GLenum target, GLuint framebuffer) const
      noexcept = 0;
...
struct OpenGLApiImpl : OpenGLApi {
  ...
  inline void genFramebuffers(GLsizei n, GLuint* ids) const noexcept override {
    glGenFramebuffers(n, ids);
  }

  inline void deleteFramebuffers(GLsizei n,
                                  GLuint* ids) const noexcept override {
  ...
  inline void drawBuffers(GLsizei n, const GLenum* bufs) const
      noexcept override {
