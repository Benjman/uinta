...
class DesktopPlatformApi {
 public:
  ...
  [[nodiscard]] virtual StatusOr<std::vector<Monitor>> findMonitors() const noexcept = 0;
  ...
  [[nodiscard]] virtual Status initOpenGL() const noexcept = 0;

  [[nodiscard]] virtual Status pollEvents() const noexcept = 0;

  [[nodiscard]] virtual StatusOr<time_t> runtime() const noexcept = 0;

  virtual Status setWindowPosition(void*, u32, u32) const noexcept = 0;
