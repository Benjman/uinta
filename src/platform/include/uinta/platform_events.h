...
struct PlatformEventPolicies {
  template <typename Event>
  static PlatformEvent getEvent(const Event& /*unused*/) {
    return getPlatformEvent<Event>();
  }
};

struct PlatformDispatchers {
  eventpp::EventDispatcher<PlatformEvent, void(const OnCloseRequestEvent&), PlatformEventPolicies> onCloseRequest;

  eventpp::EventDispatcher<PlatformEvent, void(const OnDebugMessageEvent&), PlatformEventPolicies> onDebugMessage;

  eventpp::EventDispatcher<PlatformEvent, void(const OnErrorEvent&), PlatformEventPolicies> onError;

  eventpp::EventDispatcher<PlatformEvent, void(const OnMonitorChangeEvent&), PlatformEventPolicies> onMonitorChange;

  eventpp::EventDispatcher<PlatformEvent, void(const OnViewportSizeChangeEvent&), PlatformEventPolicies>
      onViewportSizeChange;
