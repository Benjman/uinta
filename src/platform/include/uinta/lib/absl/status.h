#ifndef SRC_PLATFORM_INCLUDE_UINTA_LIB_ABSL_STATUS_H_
#define SRC_PLATFORM_INCLUDE_UINTA_LIB_ABSL_STATUS_H_
...
#endif  // SRC_PLATFORM_INCLUDE_UINTA_LIB_ABSL_STATUS_H_
