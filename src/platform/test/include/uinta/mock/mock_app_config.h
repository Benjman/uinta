...
struct MockAppConfig : AppConfig {
 ...
 public:
  ...
  std::function<std::optional<bool>(std::string)> onGetBoolean =
      [](const auto&) { return std::nullopt; };
  [[nodiscard]] std::optional<bool> getBoolean(
      std::string key) const noexcept override {
    return onGetBoolean(key);
  }

  std::function<std::optional<i32>(std::string)> onGetInt = [](const auto&) {
    return std::nullopt;
  };
  [[nodiscard]] std::optional<i32> getInt(
      std::string key) const noexcept override {
    return onGetInt(key);
  }

  std::function<std::optional<i32*>(std::string, i32*)> onGetInt2 =
      [](const auto&, auto*) { return std::nullopt; };
  ...
  std::function<std::optional<f32>(std::string)> onGetFloat = [](const auto&) {
    return std::nullopt;
  };
  [[nodiscard]] std::optional<f32> getFloat(
      std::string key) const noexcept override {
  ...
  std::function<Status(std::string, i32*)> onSetInt2 = [](const auto&, i32*) {
    return OkStatus();
  };
  ...
  std::function<Status(std::string, i32*)> onSetInt3 = [](const auto&, i32*) {
    return OkStatus();
  };
  ...
  std::function<Status(std::string, i32*)> onSetInt4 = [](const auto&, i32*) {
    return OkStatus();
  };
  ...
  std::function<Status(std::string, f32)> onSetFloat = [](const auto&, f32) {
    return OkStatus();
  };
  ...
  std::function<Status(std::string, f32*)> onSetFloat2 = [](const auto&, f32*) {
    return OkStatus();
  };
  ...
  std::function<Status(std::string, f32*)> onSetFloat3 = [](const auto&, f32*) {
    return OkStatus();
  };
  ...
  std::function<Status(std::string, f32*)> onSetFloat4 = [](const auto&, f32*) {
    return OkStatus();
  };
  ...
  [[nodiscard]] i32 schemaVersion() const noexcept override {
