...
TEST(InputTokenTest, AllModifiersCombined) {
  ...
  u32 token = Key::A | Action::Press | Mod::Shift | Mod::Control | Mod::Alt | Mod::Super | Mod::CapsLock | Mod::NumLock;
...
TEST(InputTokenTest, MultipleActions) {
  ...
  u32 multiAction = static_cast<u32>(Action::Press) | static_cast<u32>(Action::Release);
...
TEST(InputTokenTest, ConversionAllModifiers) {
  ...
  InputMod allInputMods = MOD_SHIFT | MOD_CONTROL | MOD_ALT | MOD_SUPER | MOD_CAPS_LOCK | MOD_NUM_LOCK;
