...
TEST_F(OpenGLApiTestF, GetTypeStringError) { EXPECT_EQ(OpenGLApi::GetTypeString(GL_DEBUG_TYPE_ERROR), "Error"); }

TEST_F(OpenGLApiTestF, GetTypeStringDeprecatedBehavior) {
  EXPECT_EQ(OpenGLApi::GetTypeString(GL_DEBUG_TYPE_DEPRECATED_BEHAVIOR), "Deprecated Behavior");
}

TEST_F(OpenGLApiTestF, GetTypeStringUndefinedBehavior) {
  EXPECT_EQ(OpenGLApi::GetTypeString(GL_DEBUG_TYPE_UNDEFINED_BEHAVIOR), "Undefined Behavior");
}
...
TEST_F(OpenGLApiTestF, GetTypeStringOther) { EXPECT_EQ(OpenGLApi::GetTypeString(GL_DEBUG_TYPE_OTHER), "Other"); }

TEST_F(OpenGLApiTestF, GetTypeStringMarker) { EXPECT_EQ(OpenGLApi::GetTypeString(GL_DEBUG_TYPE_MARKER), "Marker"); }
...
TEST_F(OpenGLApiTestF, GetSourceStringApi) { EXPECT_EQ(OpenGLApi::GetSourceString(GL_DEBUG_SOURCE_API), "API"); }

TEST_F(OpenGLApiTestF, GetSourceStringWindowSystem) {
  EXPECT_EQ(OpenGLApi::GetSourceString(GL_DEBUG_SOURCE_WINDOW_SYSTEM), "Window System");
}

TEST_F(OpenGLApiTestF, GetSourceStringShaderCompiler) {
  EXPECT_EQ(OpenGLApi::GetSourceString(GL_DEBUG_SOURCE_SHADER_COMPILER), "Shader Compiler");
}

TEST_F(OpenGLApiTestF, GetSourceStringThirdParty) {
  EXPECT_EQ(OpenGLApi::GetSourceString(GL_DEBUG_SOURCE_THIRD_PARTY), "Third Party");
}

TEST_F(OpenGLApiTestF, GetSourceStringApplication) {
  EXPECT_EQ(OpenGLApi::GetSourceString(GL_DEBUG_SOURCE_APPLICATION), "Application");
}

TEST_F(OpenGLApiTestF, GetSourceStringOther) { EXPECT_EQ(OpenGLApi::GetSourceString(GL_DEBUG_SOURCE_OTHER), "Other"); }
...
TEST_F(OpenGLApiTestF, GetSeverityStringLow) { EXPECT_EQ(OpenGLApi::GetSeverityString(GL_DEBUG_SEVERITY_LOW), "Low"); }

TEST_F(OpenGLApiTestF, GetSeverityStringNotification) {
  EXPECT_EQ(OpenGLApi::GetSeverityString(GL_DEBUG_SEVERITY_NOTIFICATION), "Notification");
}
