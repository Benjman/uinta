...
CityGameScene::CityGameScene(Scene* parent) noexcept
    : Scene(parent, SceneLayer::Simulation),
      ...
      intersectionRenderer_(findComponent<BasicShaderManager>().value_or(nullptr), engine()->gl()),
      pawnRenderer_(findComponent<BasicShaderManager>().value_or(nullptr), engine()->gl()) {
