...
void EconomySystem::update(time_t dt, size_t houseCount, size_t factoryCount) noexcept {
  moneyTimer_ += dt;
...
f32 EconomySystem::buildingCost(BuildingType type, size_t currentCount) const noexcept {
...
f32 EconomySystem::incomePerSecond(size_t houseCount, size_t factoryCount) const noexcept {
