 ...
 public:
  explicit TextureScene(Scene* parent, const Shader* shader) noexcept
    ...
    std::array<Vertex, 4> vertices = {
        Vertex{.position = {-0.32, 0.45f, -1}, .normal = {0, 0, 1}, .color = {1, 1, 1}, .uv = {0, 1}},
        Vertex{.position = {0.32, 0.45f, -1}, .normal = {0, 0, 1}, .color = {1, 1, 1}, .uv = {1, 1}},
        Vertex{.position = {-0.32, -0.45f, -1}, .normal = {0, 0, 1}, .color = {1, 1, 1}, .uv = {0, 0}},
        Vertex{.position = {0.32, -0.45f, -1}, .normal = {0, 0, 1}, .color = {1, 1, 1}, .uv = {1, 0}},
    };
