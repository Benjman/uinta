...
class TerrainScene : public Scene {
 public:
  ...
  void onDebugUi() noexcept override {
    bool update = false;
    update |= ImGui::SliderFloat("##terrain_width", &size_.x, 0.1f, 100.0f, "Width %.2f");
    update |= ImGui::SliderFloat("##terrain_height", &size_.z, 0.1f, 100.0f, "Height %.2f");
    update |= ImGui::SliderFloat("##terrain_depth", &size_.y, 0.1f, 20.0f, "Depth %.2f");
