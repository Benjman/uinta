...
struct IntersectionBuildings {
  ...
  BuildingId add(glm::vec3 position, glm::vec3 dims, glm::vec3 entry, BuildingType type, u8 maxOccupancy) noexcept {
  ...
  BuildingId findNearestByType(BuildingType type, glm::vec3 position) const noexcept {
