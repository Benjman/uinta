...
struct Pawns {
  ...
  std::vector<BuildingId> targetBuilding;   // Where pawn is heading (for Walking state)
  ...
  PawnId add(glm::vec3 position, f32 speed, f32 initialHunger, f32 initialEnergy, f32 initialMoney, BuildingId home,
