...
void uinta::gl::checkGlActivateTexture(GLenum err) {
...
void uinta::gl::checkGlAttachShader(GLenum err) {
	switch (err) {
...
void uinta::gl::checkGlBindBuffer(GLenum err) {
	if (err == GL_INVALID_ENUM) {
...
void uinta::gl::checkGlBindTexture(GLenum err) {
	switch (err) {
...
void uinta::gl::checkGlBindVertexArray(GLenum err) {
...
void uinta::gl::checkGlBufferData(GLenum err) {
	switch (err) {
		case GL_INVALID_ENUM:
...
void uinta::gl::checkGlBufferSubData(GLenum err) {
	switch (err) {
		case GL_INVALID_ENUM:
...
void uinta::gl::checkGlClear(GLenum err) {
...
void uinta::gl::checkGlCompileShader(GLenum err) {
	switch (err) {
		case GL_INVALID_VALUE:
...
void uinta::gl::checkGlDeleteBuffers(GLenum err) {
	if (err == GL_INVALID_VALUE) {
...
void uinta::gl::checkGlDeleteShader(GLenum err) {
	if (err == GL_INVALID_VALUE) {
...
void uinta::gl::checkGlDeleteVertexArrays(GLenum err) {
	if (err == GL_INVALID_VALUE) {
...
void uinta::gl::checkGlDisableVertexAttribArray(GLenum err) {
	if (err == GL_INVALID_VALUE) {
...
void uinta::gl::checkGlDrawArrays(GLenum err) {
	switch (err) {
		case GL_INVALID_ENUM:
...
void uinta::gl::checkGlDrawElements(GLenum err) {
	switch (err) {
		case GL_INVALID_ENUM:
...
void uinta::gl::checkGlEnable(GLenum err) {
	if (err == GL_INVALID_VALUE) {
...
void uinta::gl::checkGlEnableVertexAttribArray(GLenum err) {
	if (err == GL_INVALID_VALUE) {
...
void uinta::gl::checkGlGenBuffers(GLenum err) {
	if (err == GL_INVALID_VALUE) {
...
void uinta::gl::checkGlGenVertexArrays(GLenum err) {
	if (err == GL_INVALID_VALUE) {
...
void uinta::gl::checkGlLinkProgram(GLenum err) {
	switch (err) {
		case GL_INVALID_VALUE:
...
void uinta::gl::checkGlShaderSource(GLenum err) {
	switch (err) {
		case GL_INVALID_VALUE:
...
void uinta::gl::checkGlTexImage2D(GLenum err) {
	switch (err) {
		case GL_INVALID_ENUM:
...
void uinta::gl::checkGlTexParameteri(GLenum err) {
	if (err == GL_INVALID_ENUM) {
...
void uinta::gl::checkGlUniform(GLenum err) {
	switch (err) {
		case GL_INVALID_OPERATION:
...
void uinta::gl::checkGlUseProgram(GLenum err) {
	switch (err) {
		case GL_INVALID_VALUE:
...
void uinta::gl::checkGlVertexAttribPointer(GLenum err) {
	switch (err) {
		case GL_INVALID_VALUE:
...
void uinta::gl::uintaGlCheckError(gl_error_check_type type) {
#ifdef UINTA_DEBUG
